...
public class DateUtils {
    ...
    public static Date strParseDate(String dateStr, String pattern) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(DateUtils.date2Str(new Date(), DateUtils.Pattern.yyyy_MM_dd_HH_mm_ss));

        System.out.println(System.currentTimeMillis());
        System.out.println(System.currentTimeMillis()+3000);
        System.out.println(DateUtils.addMinutes(date1, 100));
        System.out.println(new Date());
        System.out.println(DateUtils.convertDate("2019-09-20 10:23:29", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm:ss"));
